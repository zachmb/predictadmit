...
<main class="font-sans text-slate-900 selection:bg-yellow selection:text-navy">
	...
	<section class="pa-hero-bg pa-rule-top relative pt-28 pb-20 md:pt-40 md:pb-28 overflow-hidden">
		<div class="max-w-[1200px] mx-auto px-6 text-center relative z-10 flex flex-col items-center">
			...
			<div
				class="w-full max-w-4xl mx-auto flex flex-col md:flex-row items-start justify-center gap-4 md:gap-5 relative z-20 animate-in fade-in slide-in-from-bottom-5 duration-700 delay-150 fill-mode-both"
			>
	...
	<!-- SECTION 2A: PRO SCROLL-ZOOM STORY (replaces the static section header) -->
	<ScrollZoomStory />
