	...
	<div class="min-h-[calc(100vh-64px)] flex flex-col md:flex-row bg-white">
		...
		>
			<div class="w-full max-w-[440px] flex flex-col relative bottom-[5%]">
				<!-- Header -->
				<div class="mb-8">
					<h2 class="text-[28px] font-normal text-slate-800 tracking-tight mb-2">Register</h2>
					<p class="text-[15px] text-slate-600">
						Already have an account?
						<a
							href="/account"
							class="text-[#7A52E1] hover:underline hover:text-[#5F35CD] font-medium ml-1">Log In</a
						>
					</p>
				</div>
				...
				<div class="space-y-4">
					<div class="flex flex-col gap-1.5">
						<label for="fname" class="text-[14px] font-medium text-slate-700">First Name</label>
						<input
							type="text"
							id="fname"
							class="w-full px-3 py-2.5 border border-slate-300 rounded-[4px] text-slate-800 placeholder-slate-400 focus:outline-none focus:border-[#7A52E1] focus:ring-1 focus:ring-[#7A52E1] transition-shadow text-[15px]"
						/>
					</div>

					<div class="flex flex-col gap-1.5">
						<label for="work-email" class="text-[14px] font-medium text-slate-700"
					...
					<div class="flex flex-col gap-1.5">
						<label for="password" class="text-[14px] font-medium text-slate-700">Password</label>
						<input
							type="password"
							id="password"
							class="w-full px-3 py-2.5 border border-slate-300 rounded-[4px] text-slate-800 placeholder-slate-400 focus:outline-none focus:border-[#7A52E1] focus:ring-1 focus:ring-[#7A52E1] transition-shadow text-[15px]"
					...
					<label class="flex items-start gap-3 mt-4 cursor-pointer group">
						<div class="relative flex items-center pt-1">
							<input
								type="checkbox"
								class="w-[14px] h-[14px] mt-[2px] border-slate-300 rounded-[3px] text-[#7A52E1] focus:ring-[#7A52E1] cursor-pointer"
							/>
						</div>
						<span class="text-[13px] text-slate-600 leading-[1.4] select-none">
							I agree to the <a href="/terms" class="text-[#7A52E1] hover:underline"
								>Website Terms of Use</a
							>,
							<a href="/terms" class="text-[#7A52E1] hover:underline">End User Terms of Service</a>,
							and
					...
					<div class="mt-6 space-y-4 pt-2">
						<button
							class="w-full bg-[#8b5cf6] hover:bg-[#7c3aed] text-white font-medium py-[10px] px-4 rounded-[4px] transition-colors flex items-center justify-center text-[15px]"
						>
							Sign up
						</button>
						...
						<button
							...
							class="w-full bg-white border border-slate-200 hover:bg-slate-50 text-slate-600 font-medium py-[10px] px-4 rounded-[4px] transition-colors flex items-center justify-center gap-2.5 text-[15px] shadow-[0_1px_2px_rgba(0,0,0,0.03)]"
						>
