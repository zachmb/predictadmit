...
<div class="min-h-screen bg-slate-50 text-slate-700 p-4 md:p-8 font-sans">
    <header class="mb-8">
        ...
        <p class="text-slate-500 text-sm italic">Harsh grading based on your stored profile and supplemental essays.</p>
    </header>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-7xl mx-auto">
            ...
            <div class="lg:col-span-4 space-y-6">
                <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-xl">
                    <div class="mb-6">
                        <label class="block text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-2">Target University</label>
                    ...
                    <div class="mb-6">
                        <div class="flex justify-between items-end mb-2">
                            <label class="text-[10px] font-bold uppercase tracking-widest text-slate-400">Profile Data</label>
                    ...
                    <div class="space-y-4">
                        <label class="block text-[10px] font-bold uppercase tracking-widest text-slate-400">Intended Major</label>
            ...
            <div class="lg:col-span-8 bg-white rounded-xl border border-slate-200 shadow-xl overflow-hidden">
                
                <div class="p-8 border-b border-slate-100 flex justify-between items-center">
                    <h2 class="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400">Decision Outcome</h2>
                    <div class="flex items-center gap-4">
                        <div class="text-4xl font-black uppercase italic tracking-tighter {outcomeColors[schoolData.outcome]}">
                            {schoolData.outcome}
                        </div>
                    </div>
                </div>
                ...
                <div class="p-8 grid md:grid-cols-2 gap-12">
                    <div class="flex flex-col items-center">
                        <svg width="300" height="300" viewBox="0 0 300 300" class="filter drop-shadow-sm">
                            ...
                            <text x="150" y="30" text-anchor="middle" class="fill-slate-400 text-[10px] font-bold">ACADEMIC</text>
                            <text x="270" y="130" text-anchor="start" class="fill-slate-400 text-[10px] font-bold">EXTRACURRICULAR</text>
                            <text x="220" y="270" text-anchor="middle" class="fill-slate-400 text-[10px] font-bold">INTELLECTUAL</text>
                            <text x="80" y="270" text-anchor="middle" class="fill-slate-400 text-[10px] font-bold">CHARACTER</text>
                            <text x="30" y="130" text-anchor="end" class="fill-slate-400 text-[10px] font-bold">FIT</text>
