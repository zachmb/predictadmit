...
<svelte:head>
	<title
		>Junior Year College Admissions Diagnostic: Find & Fix Your Application Gaps | PredictAdmit</title
	>
	<meta
		name="description"
		content="A step-by-step junior year college admissions diagnostic: run an objective gap analysis, project your test scores, build a balanced reach/target/safety list, and fix weaknesses before senior year."
	/>
	<meta
		property="og:title"
		content="Junior Year College Admissions Diagnostic: Find & Fix Your Application Gaps"
	/>
	<meta
		property="og:description"
		content="Objectively assess your application as a high school junior. Find the gaps, project scores, and build a balanced college list before senior fall."
	/>
...
<main class="min-h-screen bg-white font-sans text-slate-800 antialiased">
	<article class="mx-auto max-w-3xl px-6 py-16 md:py-24">
		...
		<header class="mb-12">
			<div
				class="inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-xs font-bold uppercase tracking-wide text-[#0052CC]"
			>
			...
			<h1
				class="mt-6 text-4xl font-black leading-[1.1] tracking-tight text-slate-900 md:text-5xl"
			>
		...
		<div class="space-y-10 text-[17px] leading-8 text-slate-700">
			<section>
				...
				<p class="mt-4">
					...
					year. Your junior-year transcript is the last complete year on your application. Your
					standardized testing is usually finished by the end of junior year or early fall. The
					activities you list have to already exist. In other words, senior fall is where you
					<em>present</em> your profile &mdash; junior year is where you still get to
					<em>change</em> it.
				</p>
				<p class="mt-4">
					That's what makes a junior-year diagnostic so valuable. A weakness you spot in October of
					junior year is a fixable problem: you can add a rigorous course, retake a test, deepen an
					activity, or start something that matters. The same weakness spotted in October of senior
					year is just a fact you have to write around. The goal of this guide is to help you see
					those gaps a full year early, while they're still cheap to fix.
				</p>
			</section>
			...
			<section>
				...
				<p class="mt-4">
					Holistic admissions sounds vague, but at most selective schools it reduces to a handful of
					pillars. Score yourself honestly on each &mdash; not against your friends, but against the
					students who were <em>admitted</em> to the schools you want.
				</p>
				<ul class="mt-4 space-y-3">
					<li class="flex gap-3">
						<span class="mt-1 font-bold text-[#0052CC]">1.</span>
						<span
					...
					<li class="flex gap-3">
						<span class="mt-1 font-bold text-[#0052CC]">2.</span>
						<span
					...
					<li class="flex gap-3">
						<span class="mt-1 font-bold text-[#0052CC]">3.</span>
						<span
					...
					<li class="flex gap-3">
						<span class="mt-1 font-bold text-[#0052CC]">4.</span>
						<span
					...
					<li class="flex gap-3">
						<span class="mt-1 font-bold text-[#0052CC]">5.</span>
						<span
			...
			<section>
				...
				<p class="mt-4">
					A gap analysis is simple in principle: compare where you are now to where admitted
					students at your target schools were, pillar by pillar, and flag every gap. The trick is
				...
				<div class="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-6">
					...
					<ul class="mt-4 space-y-3 text-slate-700">
						<li class="flex gap-3">
							<span class="text-[#0052CC]">&#10003;</span> Pull your school's course catalog and count
							how many of the most rigorous classes you've actually taken.
						</li>
						<li class="flex gap-3">
							<span class="text-[#0052CC]">&#10003;</span> Look up the middle-50% test range for each
							target school and mark where your current score falls.
						</li>
						<li class="flex gap-3">
							<span class="text-[#0052CC]">&#10003;</span> Rank your activities by real impact, not by
							title. Circle the one you'd talk about in an interview.
						</li>
						<li class="flex gap-3">
							<span class="text-[#0052CC]">&#10003;</span> Write one sentence describing your "hook"
							or narrative. If you can't, that's a gap.
						</li>
						<li class="flex gap-3">
							<span class="text-[#0052CC]">&#10003;</span> For each target school, note whether you're
				...
				<p class="mt-6">
					The single most common mistake here is comparing yourself to the average
					...
					<a href="/pro" class="font-semibold text-[#0052CC] underline decoration-blue-200 underline-offset-2 hover:decoration-blue-500">PredictAdmit Pro</a>
			...
			<section>
				...
				<p class="mt-4">
					Junior-year testing is a projection problem, not a snapshot. A 1380 in November of junior
					year with two more test dates and structured prep ahead of it is a different data point
					than a 1380 taken cold once. To project honestly:
				</p>
				<ul class="mt-4 space-y-2">
					<li class="flex gap-3">
						<span class="text-[#0052CC]">&bull;</span> Take a full-length, timed diagnostic under real
						conditions to get a true baseline.
					</li>
					<li class="flex gap-3">
						<span class="text-[#0052CC]">&bull;</span> Assume realistic gains: 50&ndash;100 points on the
						SAT from disciplined prep is typical; 200+ is rare and shouldn't anchor your plan.
					</li>
					<li class="flex gap-3">
						<span class="text-[#0052CC]">&bull;</span> Plan your test dates <em>backward</em> from application
						deadlines so your last attempt lands before you apply.
					</li>
					<li class="flex gap-3">
						<span class="text-[#0052CC]">&bull;</span> Decide test-optional strategy per school: if your
			...
			<section>
				...
				<p class="mt-4">
					Once you know your projected profile, sort schools by how your numbers compare to each
					one's admitted class. A balanced list isn't about prestige tiers &mdash; it's about
			...
			<section>
				...
				<p class="mt-4">
					These aren't dramatic errors &mdash; they're the slow leaks that cost strong students
					their reaches:
				</p>
				<ul class="mt-4 space-y-3">
					<li class="flex gap-3">
						<span class="text-[#0052CC]">&bull;</span>
						<span
			...
			<!-- Pro callout -->
			<section
				class="rounded-3xl border border-blue-100 bg-gradient-to-br from-blue-50 to-white p-8 md:p-10"
			>
				<div
					class="inline-flex items-center gap-2 rounded-full bg-[#0052CC] px-3 py-1 text-xs font-bold uppercase tracking-wide text-white"
				>
					Built into PredictAdmit Pro
				</div>
				<h2 class="mt-5 text-2xl font-bold tracking-tight text-slate-900 md:text-3xl">
				...
				<div class="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
					<a
						href="/pro"
						class="inline-flex items-center justify-center rounded-xl bg-[#0052CC] px-6 py-3.5 text-base font-bold text-white shadow-lg shadow-blue-200 transition-all hover:-translate-y-0.5 hover:bg-blue-700"
					>
						Run your diagnostic in PredictAdmit Pro &rarr;
					</a>
					<div class="flex items-center gap-5 text-sm font-semibold text-slate-600">
						<a href="/portals" class="hover:text-[#0052CC]">Explore all portals</a>
						<a href="/ai" class="hover:text-[#0052CC]">Meet the AI counselor</a>
					</div>
				</div>
			</section>
