		...
		<header class="bg-white border-b border-slate-300">
			<div class="max-w-5xl mx-auto px-6 pt-6 pb-4 flex items-center justify-between">
				<div class="flex items-baseline gap-3">
					<span class="text-3xl font-serif text-[#866D4B]"> Vanderbilt </span>
	...
	<div class="min-h-screen bg-slate-100">
		...
		<div class="max-w-7xl mx-auto px-6 py-8">
			...
			<div class="flex gap-2 mb-6">
				<button
					class="px-6 py-2 bg-slate-200 border border-slate-400 text-slate-800 text-sm font-semibold"
				>
					Application
				</button>
				<button
					class="px-6 py-2 bg-white border border-slate-300 text-slate-600 text-sm hover:bg-slate-50"
				>
					Financial Aid
				</button>
				<button
			...
			<div class="bg-white border border-slate-300 shadow-sm mb-6">
				...
				<div class="px-6 py-4">
					<p class="text-sm text-slate-700 leading-relaxed mb-3">
						<strong>NOTE:</strong> MyAppVU portal is the only way to receive your Vanderbilt admissions
						decision. Any official email communication from the Office of Undergraduate Admissions will
						come from a vanderbilt.edu email address.
					</p>
					<p class="text-sm text-slate-600 leading-relaxed">
						It may take up to two business days for application parts and test scores to be
						reflected in this portal. Only requested items appear on the checklist. For example, SAT
						II/subject test scores and additional recommendation letters will not appear on the
						checklist as their scores fall.
					</p>
				</div>
			</div>
			...
			<div class="grid grid-cols-3 gap-6">
				...
				<div class="col-span-2 space-y-6">
					...
					<div class="bg-white border border-slate-300 shadow-sm">
						...
						<div class="px-6 py-4">
							<p class="text-sm text-slate-700 leading-relaxed mb-4">
								You are no longer permitted to submit charges to your Vanderbilt decision plan as of
								the date of choice. Decision plan and school of choice charges can be submitted only
								up to two weeks after the decision date.
								<strong
									>Additional charges as part of the CommonApp or a decision plan in Early Decision
									1 or 2: Agreement: A required fee of $400 to access and to process your Early
									Decision plan in Early Decision 1 or 2.</strong
								>
							</p>
						</div>
					</div>
					...
					<div class="bg-white border border-slate-300 shadow-sm">
						...
						<div class="px-6 py-4">
							<p class="text-sm text-slate-700 leading-relaxed mb-4">
								You may upload application materials using the drop-down below. The only "required
								documents" that can be uploaded (and will appear on your MyAppVU checklist) are the
								Early Decision Agreement and self-reported testing. Required materials such as high
								school transcripts and teacher recommendations cannot be submitted through this
								upload tool. To be considered official, these materials must be submitted directly
								from the application platform or from your high school. DO NOT upload materials that
								are not listed in the drop-down menu.
							</p>
							<p class="text-sm text-slate-600 mb-4">
								Because all items uploaded will be added to your admissions file and will be
								considered if submitted in time for admissions review, it is not necessary to
								contact your admissions office regarding these materials.
							</p>
							<div class="flex items-center gap-3">
								<select
									class="px-3 py-2 border border-slate-400 bg-white text-sm text-slate-700 min-w-[200px]"
								>
									<option>Choose File</option>
								</select>
								<span class="text-sm text-slate-500">No file chosen</span>
								<button
									class="px-4 py-2 bg-slate-200 border border-slate-400 text-slate-800 text-sm font-semibold hover:bg-slate-300"
								>
									Upload
								</button>
							</div>
					...
					<div class="bg-white border border-slate-300 shadow-sm">
						<div class="bg-slate-100 px-6 py-3 border-b border-slate-200">
							<h3 class="text-lg font-semibold text-slate-800">
								Your Vanderbilt Admissions Counselor
							</h3>
						</div>
						<div class="px-6 py-4">
							<p class="text-sm text-Black-700 underline cursor-pointer hover:text-blue-900">
								» Ricky Thrash
							</p>
						</div>
					</div>
					...
					<div class="bg-white border border-slate-300 shadow-sm">
						...
						<div class="px-4 py-3">
							...
							<div class="text-xs font-bold text-slate-800 mb-2">
								New Senior Admissions Counselor
							</div>
							<div class="text-xs text-slate-700 mb-2">Arianna Yamillo</div>
							<p class="text-xs text-slate-600 leading-relaxed">
								Hi there—My name is Arianna Yamillo, and I've worked in the Office of Undergraduate
								Admissions since graduating from Vanderbilt in 2018! I live in New York City and
								work on students here and in Long Island, Fairfield County, Central American, the
								Caribbean, Mexico, the U.S. territories, and parts of China (what?) in the office! I
								help plan events(!) and serve on our Diversity, Equity, and Inclusion Initiatives. I
								enjoy working magical illusions and tips; and going, meeting friends and family to
								homeschooled teens. Let me know if you have any recipes you think I...
							</p>
						</div>
					</div>
				</div>
...
{:else if $decisionsBySlug['vanderbilt'] === 'admit'}
