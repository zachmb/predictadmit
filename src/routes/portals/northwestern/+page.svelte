...
<div class="min-h-screen font-sans text-slate-900 bg-white">
	{#if !authenticated}
		<header class="bg-[#4E2A84] border-b border-slate-300 text-white">
			<div
				class="max-w-7xl mx-auto px-6 py-2 text-[11px] flex justify-end gap-4 uppercase font-semibold border-b border-[#6f4b9c]"
			>
			...
			<div class="max-w-7xl mx-auto px-6 pt-4 pb-2 flex items-baseline justify-between">
				<div class="flex items-end gap-3">
					<span class="text-3xl font-serif font-extrabold text-white"> Northwestern </span>
		...
		<section class="bg-white min-h-[500px] py-10">
			<div class="max-w-4xl mx-auto px-10">
				<div class="max-w-3xl mx-auto text-[13px]">
					<h1
						class="text-2xl font-normal mb-8 font-serif text-[#4E2A84] border-b border-slate-300 pb-2"
					>
						Portal Login
					</h1>

					<div
						class="border border-green-700 bg-[#E0FFE0] px-4 py-3 mb-6 text-[13px] text-slate-900 font-normal max-w-[500px]"
					>
		...
		<footer
			class="bg-[#4E2A84] h-8 flex items-center justify-center text-white text-[11px] font-normal"
		>
	...
	{:else if !hasViewedUpdate}
		<header class="bg-[#4E2A84] text-white">
			<div
				class="max-w-7xl mx-auto px-6 py-2 text-[11px] flex justify-end gap-4 uppercase font-semibold"
			>
				<a href="/disclaimer" class="hover:underline">For Counselors</a>
				<a href="/disclaimer" class="hover:underline">Viewbook</a>
				<a href="/disclaimer" class="hover:underline">Social Media</a>
		...
		<main class="bg-white py-8 min-h-[500px]">
			<div class="max-w-7xl mx-auto px-6">
				<div class="flex border-b border-gray-300 mb-6">
					<div
						class="bg-[#4E2A84] text-white px-4 py-2 text-sm font-semibold border-r border-white"
					>
						Application Status
					</div>
					<div
						class="text-[#4E2A84] px-4 py-2 text-sm font-semibold hover:bg-gray-100 cursor-pointer"
					>
				...
				<div class="max-w-2xl">
					...
					<p class="text-sm text-red-700 mb-4">
						This page is your application status portal and will be used to monitor the progress of
						your application and to communicate any important updates or changes to your
						application. When decisions become available they will also be posted here.
					</p>

					<p class="text-sm text-slate-700 mb-6">
						If you have any questions please reach out to us at <a
							href="mailto:ug-admission@northwestern.edu"
							class="text-blue-600 hover:underline">ug-admission@northwestern.edu</a
						>
						or (847) 491-7271 and provide the following reference number:
						<span class="font-bold">{school.admissionsId}</span>.
					</p>

					<h3 class="font-bold text-lg mb-2 text-slate-800 border-b border-gray-300 pb-1">
						Status Update
					</h3>
			...
			<div class="max-w-7xl mx-auto px-6 grid grid-cols-4 gap-8 text-[13px]">
				<div>
					...
					<p class="text-[12px] leading-relaxed mb-4">
						...
						<br />
						<a href="/disclaimer" class="text-white/80 hover:underline"
							>Campus Emergency Information</a
						>
						<br />
				...
				<div>
					...
					<div class="space-y-1 text-white/90 text-[12px]">
						...
						<p class="pt-2">
							@: <a href="mailto:ug-admission@northwestern.edu" class="hover:underline"
								>ug-admission@northwestern.edu</a
							>
						</p>
					</div>
				</div>
	...
	{:else if $decisionsBySlug['northwestern'] === 'admit'}
