...
<main class="min-h-screen bg-slate-100 text-slate-900 font-sans">
			...
			<div class="max-w-2xl mx-auto px-6 py-12">
				...
				<form on:submit={handleLogin} class="space-y-6">
					...
					<div class="text-sm text-slate-600 bg-slate-50 border border-slate-200 px-4 py-3">
						<strong>Note:</strong> Use the same email and password you created on the PredictAdmit main
						page.
					</div>
					...
					<button
						...
						class="ml-4 text-xs text-[#003262] hover:underline"
					>
						Use PredictAdmit Credentials?
					</button>
				</form>

				<div class="mt-8 pt-8 border-t border-slate-300 text-sm text-slate-600">
					<p>
						Questions about your application? Visit the Application FAQs or the University of
				...
				<div class="flex gap-6">
					...
					<div class="flex-1">
						...
						<div class="flex justify-end mb-6">
							<button
								class="bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold px-6 py-2"
							>
								{applicantName()}
							</button>
						</div>
						...
						<div
							class="bg-gradient-to-r from-[#FDB515] to-[#FFD966] text-[#003262] p-8 mb-6 relative overflow-hidden"
						...
						>
							<div class="relative z-10">
								...
								<p class="text-sm max-w-md">
									If you need to complete any outstanding items for your application, you can do so
									here.
								</p>
							</div>
					...
					<div class="w-80">
						...
						<div class="bg-[#E8F4F8] border border-[#4A90A4] border-t-0 p-6 text-sm text-slate-700">
							<p>
								Information about financial aid and scholarships will be available after admission
	...
	{:else if $decisionsBySlug['ucberkeley'] === 'admit'}
