...
<svelte:head>
  <title>Rice University Undergraduate Admissions Portal</title>
</svelte:head>

<main class="min-h-screen bg-slate-200 text-slate-900 font-serif">
  {#if !authenticated}
    <!-- FULL-SCREEN RICE LOGIN (Duke style, Rice Blue) -->
    <div class="min-h-screen flex items-center justify-center px-4">
      <div class="w-full max-w-md bg-white border border-slate-500 shadow-md">
        <div class="bg-[#00205B] text-white border-b border-slate-700 px-4 py-3">
        ...
        <form class="px-4 py-4 space-y-3" on:submit={handleLogin}>
          ...
          <div>
            ...
            <input
              id="rice-email"
              type="email"
              class="w-full border border-slate-500 bg-slate-50 px-3 py-2 text-sm shadow-inner focus:outline-none focus:ring-1 focus:ring-[#00205B]"
          ...
          <button
            type="submit"
            class="mt-2 inline-block bg-[#00205B] text-white text-sm font-semibold px-4 py-2 border border-[#001844] shadow hover:bg-[#001844] focus:outline-none focus:ring-1 focus:ring-[#00205B]"
          >
            Log In
          </button>
  ...
  {:else}
    ...
    {#if !hasViewedUpdate}
      ...
      <AdmissionsPortalTemplate
        logoPrimary="RICE"
        logoSecondary="ADMISSION"
        schoolName="Rice University"
        primaryColor="#00205B"
        applicantName={applicantName()}
        admissionsId="2026-RICE-556677"
        financialAidId="FA-889900"
        bannerText="Thank you for applying to Rice University!"
        noticeText="Admission decisions for Regular Decision applicants will be available Wednesday, March 27, 2024 at 5:00 PM Central Time."
        ...
        additionalSections={[
          {
            ...
            content: `
              ...
              <p><strong>Proposed Major:</strong> Computer Science</p>
              <p><strong>Application ID:</strong> RICE-556677</p>
            ...
            content: `
              <div class="space-y-2">
                ...
                <div class="flex items-center text-green-600">
                  ...
                  <span>Rice Supplement (Submitted)</span>
                </div>
                <div class="flex items-center text-green-600">
                  <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
          ...
          {
            title: 'Residential College System',
            content: `
              <p class="text-sm mb-2">Rice University's unique residential college system includes:</p>
              <ul class="text-sm list-disc pl-5 space-y-1 text-gray-700">
                <li>11 residential colleges, each with its own traditions and community</li>
                <li>Faculty associates who live in or are affiliated with each college</li>
                <li>College-specific dining halls, common spaces, and student government</li>
                <li>Students remain affiliated with their college throughout their time at Rice</li>
              </ul>
            `
          },
          {
            ...
            content: `
              <p><strong>Undergraduate Admission:</strong> 713-348-7423</p>
              <p><strong>Email:</strong> <a href="mailto:admission@rice.edu" class="text-[#00205B] hover:underline">admission@rice.edu</a></p>
              <p><strong>Office Hours:</strong> Monday–Friday, 8:30 AM–5:00 PM CST</p>
              <p class="mt-2 text-sm text-gray-600">Please have your Application ID (RICE-556677) ready when contacting our office.</p>
            `
          }
        ]}
      />
