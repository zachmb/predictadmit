	...
	{#if !authenticated}
		...
		<main class="bg-white min-h-[520px] py-16">
			<div class="max-w-2xl mx-auto px-6">
				...
				<form class="space-y-5 max-w-lg" on:submit={handleLogin} autocomplete="off">
					{#if error}
						<p
					...
					<div class="flex items-center gap-3 pt-2">
						...
						<button
							type="button"
							class="border border-slate-400 bg-slate-100 px-3 py-2 text-xs text-slate-700 hover:bg-slate-200"
