				...
				<form class="space-y-5" on:submit={autoLogin}>
					...
					<div class="flex flex-wrap items-center gap-x-6 gap-y-2">
						...
						<input
							id="portal-email"
							type="email"
							class="w-full max-w-[16rem] sm:w-72 border border-gray-300 bg-[#f2f2f2] px-2 py-1.5 text-[13px]"
					...
					<div class="flex items-center gap-4 pt-3 sm:pl-[152px]">
						<button
					...
					<p class="max-w-2xl pt-4 text-[11px] leading-relaxed text-gray-500 sm:pl-[152px]">
