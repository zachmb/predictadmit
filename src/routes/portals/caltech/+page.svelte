	...
	{#if !authenticated}
			...
			<div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
				<div class="flex items-center gap-3">
					<span class="text-2xl font-serif font-bold" style="color: {school.primaryColor};"
						>Caltech</span
					>
					<span class="text-sm font-light uppercase tracking-widest text-slate-700"
		...
		<main class="bg-white min-h-[500px] py-24">
			<div class="max-w-xl mx-auto px-6 text-[13px]">
				<h1 class="text-2xl font-normal mb-8 text-slate-900">Login</h1>

				<div
					class="px-4 py-2 mb-8 text-[13px] font-normal border"
					style="border-color: #A3C989; background-color: #F1FCE8;"
				>
					To log in, please enter your email address and password.
				</div>

				<form class="space-y-4 max-w-[500px] mx-auto" on:submit={autoLogin}>
					{#if error}
						<p
	...
	{:else if !hasViewedUpdate}
		...
		<main class="bg-white py-8 min-h-[700px]">
			<div class="max-w-4xl mx-auto px-6">
				...
				<p class="text-sm text-slate-700 mb-4 leading-relaxed">
					Kickback, relax and know the hardest part is done – you’ve applied! We are grateful you
					decided to submit an application to Caltech.
				</p>
				<p class="text-sm text-slate-700 mb-6 leading-relaxed">
					The Beaver Breakroom is a space designed to let you learn more about the status of your
					application and provides you a way to update your application.
				</p>

				<p class="text-sm text-slate-700 mb-8 font-semibold">
					<span class="text-red-600">Please note</span> - the Caltech Undergraduate Admissions Office
					**will not** share information about your application by phone or email.
				</p>
				...
				<div
					class="mb-12 p-4 border border-yellow-400 shadow-inner"
					style="background-color: {HIGHLIGHT_YELLOW};"
				>
					<p class="text-base text-slate-800 font-bold mb-3">
						New updates to your application were posted {school.statusLastPosted}.
					</p>
					<p class="text-sm text-slate-700 mb-4">Your admission decision is now available.</p>
				...
				<h2 class="text-xl font-bold mb-4" style="color: {CALTECH_PRIMARY_COLOR};">
				...
				<table class="w-full text-sm text-left border border-gray-300 mb-8">
					...
					<tbody>
						...
						<tr>
							<td class="px-4 py-2 text-green-700 font-semibold">✔ Received</td>
							<td class="px-4 py-2"
								>Signed 2021 Parent Tax Return or Parent Non-Tax Filer's Statement</td
							>
						</tr>
					</tbody>
				</table>
				...
				<p class="text-sm mb-6 text-slate-700">
					<span class="text-green-700 font-semibold">✔ 11/06/2022</span> Caltech QuestBridge
					Supplement <a href="/disclaimer" class="text-blue-600 hover:underline ml-1">Display</a>
				</p>
				...
				<p class="text-sm text-slate-700 mb-4 leading-relaxed">
					Optional. There’s that word again that can make students start to panic. At Caltech, we
					**strongly** believe that we have asked in our application what we need to know about a
					student who applies to Caltech. However, we recognize that sometimes students want to add
					more materials to their application. If you **strongly** believe that additional material
					will help us, you may help your application. Click <a
						href="/disclaimer"
		...
		<footer class="bg-gray-800 text-white py-6 text-sm font-normal">
			<div class="max-w-6xl mx-auto px-6">
				<div
					class="flex justify-between items-start text-[12px] pb-4 border-b border-gray-700 mb-4"
				>
