	...
	<div class="min-h-screen bg-stone-50">
			...
			<div class="max-w-6xl mx-auto px-6 flex items-center justify-between">
				<div class="flex items-center gap-4">
					<div class="w-16 h-16 bg-white rounded-full flex items-center justify-center">
						<div class="text-[#A51417] font-bold text-xs text-center leading-tight">
							WASHU<br />1853
						</div>
					</div>
		...
		<section class="bg-white">
			<div class="max-w-4xl mx-auto px-10 py-12">
				<h1 class="text-3xl font-normal mb-2 text-stone-800">WashU Pathway Login</h1>
				...
				<form class="space-y-6" on:submit={handleLogin}>
					{#if error}
						<div
							class="bg-red-50 border border-red-300 text-red-800 px-4 py-3 text-sm"
							role="alert"
						>
							{error}
						</div>
					...
					<div>
						...
						<a
							href="/portals/washu"
							class="text-sm text-[#A51417] hover:underline mt-2 inline-block"
						>
					...
					<div class="flex items-center gap-4 pt-2">
						...
						<button
							type="button"
							class="border border-stone-400 bg-stone-100 px-4 py-2 text-xs hover:bg-stone-200 transition-colors"
					...
					<p
						class="pt-4 text-xs text-stone-600 max-w-2xl leading-relaxed border-t border-stone-200 mt-6"
					>
			...
			<div class="max-w-6xl mx-auto px-6 text-xs">
				<div class="flex items-center justify-between">
					...
					<span class="opacity-70"
						>PredictAdmit.com simulation · Not affiliated with Washington University</span
					>
				</div>
			</div>
		</footer>
	...
	<div class="bg-stone-50 min-h-screen">
		<main class="max-w-7xl mx-auto px-8 py-12">
			<div class="flex items-center justify-between mb-8">
				...
				<a
					href="/portals/washu"
					class="text-xs text-stone-500 uppercase tracking-wide hover:text-[#A51417]"
				>
			...
			<div class="grid grid-cols-3 gap-8">
				...
				<div class="col-span-2 space-y-6">
					...
					<div class="space-y-4 text-sm text-stone-700 leading-relaxed">
						<p>
							Your Regular Decision application for admission is complete! Please check back for
							important updates.
						</p>
						<p>
							You have elected to submit standardized tests scores in your application for
							admission. You may report new ACT or SAT scores using this form - <a
								href="/portals/washu"
								class="text-[#A51417] underline">Self-Reported Test Scores</a
							>.
						</p>
						<p>
							If you report test scores, we will use these test scores to read and make a decision
							on your application. Enrolling students who elect to provide test scores and who
							self-report scores on their application will be required to send official scores from
							the testing agency.
						</p>
					</div>
				</div>
					...
					<div class="bg-white border border-stone-200 overflow-hidden">
						<div class="p-6">
							...
							<p class="text-sm text-stone-700 leading-relaxed mb-4">
								If you have questions about your application checklist, or if you have a change to
								your mailing address or email, contact your Admissions Services Coordinator:
							</p>
						</div>
...
{:else if $decisionsBySlug['wustl'] === 'admit'}
