	...
	{#if !authenticated}
		...
		<main class="bg-white min-h-[520px] py-16">
			<div class="max-w-xl mx-auto px-6">
				...
				<form class="space-y-5 max-w-[440px]" on:submit={handleLogin}>
					{#if error}
						<p
					...
					<div class="flex items-center gap-3 pt-2">
						...
						<button
							type="button"
							class="px-4 py-2 text-[12px] rounded-sm border border-slate-400 bg-slate-100 text-slate-700 hover:bg-slate-200"
