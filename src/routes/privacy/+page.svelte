...
<main class="min-h-screen pa-grid font-sans text-navy flex flex-col">
	<div class="flex-1 max-w-3xl mx-auto px-6 py-24 w-full">
		...
		>
			...
			<p>
				At PredictAdmit, accessible from predictadmit.com, one of our main priorities is the privacy
				of our visitors. This Privacy Policy document contains types of information that is
				collected and recorded by PredictAdmit and how we use it.
			</p>
			...
			<h2>Log Files</h2>
			<p>
				PredictAdmit follows a standard procedure of using log files. These files log visitors when
			...
			<p>
				...
				contact us at <a href="mailto:hello@predictadmit.com">hello@predictadmit.com</a>.
			</p>
		</div>
	</div>
	<SiteFooter />
