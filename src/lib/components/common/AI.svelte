...
>
	...
	<div class="relative px-5 pt-5 pb-4 md:px-6 md:pt-6 md:pb-5 space-y-4">
		...
		<div class="flex items-center justify-between gap-3">
			...
			<span class="hidden text-[10px] text-slate-400 md:inline"> Premium AI narrative engine </span>
		</div>
		...
		<div class="space-y-3">
			...
			<p class="max-w-md text-[12px] md:text-sm text-slate-200/90">
				Simulate your predicted decisions hitting your inbox and get the help you need to turn every
				one of them into 'congratulations'.
			</p>
		</div>
