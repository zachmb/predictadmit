...
<div class="min-h-screen bg-white p-8 font-serif">
	<div class="max-w-2xl mx-auto">
		...
		<div class="mb-8 leading-relaxed text-gray-800">
			...
			<p class="mb-4">
				Thank you for your application to the University of California, Berkeley. After careful
			...
			<p class="mb-4">
				This year, UC Berkeley reviewed applications from an exceptionally accomplished pool of more
				than 125,000 candidates. Each application was evaluated holistically, considering academic
			...
			<div class="my-8 p-6 bg-gray-50 border-l-4 border-[#003262] italic">
				...
				<p class="text-gray-600">
					As the world's premier public university, Berkeley seeks students who demonstrate
					exceptional academic ability, intellectual curiosity, and a commitment to public service.
					While you have clearly demonstrated significant accomplishments, the limitations of our
					enrollment capacity prevent us from admitting many outstanding students who would
					undoubtedly thrive at Berkeley.
				</p>
			</div>
