	...
	<div class="max-w-2xl mx-auto">
		...
		<div class="border-b-2 border-gray-300 pb-4 mb-8">
			<div class="flex items-center mb-4">
				...
				<div>
					<h1 class="text-2xl font-bold text-gray-700">University of Pennsylvania</h1>
		...
		<div class="mb-8 leading-relaxed text-gray-800">
			...
			<p class="mb-4">
				Thank you for your application to the University of Pennsylvania. The Admissions Committee
				has completed its review, and I regret to inform you that we are unable to offer you
				admission to the Class of 2028.
			</p>

			<p class="mb-4">
				This year, Penn received more than 59,000 applications for approximately 2,400 places in the
				first-year class—the most competitive selection process in our history. Each application was
				reviewed thoroughly within the context of the applicant's available opportunities,
				considering academic achievement, personal qualities, and potential contributions to our
				community.
			</p>

			<div class="my-8 p-6 bg-gray-50 border-l-4 border-[#990000] italic">
				<p class="mb-2 font-semibold text-gray-700">About Our Selection Process</p>
				<p class="text-gray-600">
					Our holistic review considers each applicant's unique combination of talents, experiences,
					and aspirations. While you have clearly accomplished a great deal, the limitations of our
					class size prevent us from admitting many outstanding students who would undoubtedly
					thrive at Penn.
				</p>
			</div>
			...
			<p class="mb-4">
				...
				rather than any deficiency in your accomplishments or potential. We have every confidence
				that you will find success and make meaningful contributions at another excellent
				institution.
			</p>
