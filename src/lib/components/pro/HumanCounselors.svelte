		...
		<header class="mb-8">
			...
			<div class="mt-4 flex flex-wrap items-center gap-3 text-xs font-medium text-slate-500">
				<span class="inline-flex items-center gap-1.5 rounded-full bg-emerald-50 px-3 py-1 text-emerald-700">
					...
					Admit lists verified from official decision letters
				</span>
					...
					<div class="flex items-start gap-3">
						...
						<div class="min-w-0 flex-1">
							<div class="flex items-center gap-1.5">
								...
								{#if c.verified}
									<span title="Admit verified" class="inline-flex items-center gap-1 rounded-full bg-emerald-50 px-1.5 py-0.5 text-[10px] font-bold text-emerald-700">
			...
			<div class="min-h-0 flex-1 overflow-y-auto p-5">
				...
				{:else}
					...
					<div class="mb-5 space-y-2">
						...
						{/each}
						<p class="text-xs text-slate-500"><span class="font-bold text-slate-600">Verified admits:</span> {c.acceptedTo.join(' · ')}</p>
					</div>
