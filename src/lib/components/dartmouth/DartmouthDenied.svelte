...
<div class="min-h-screen bg-white p-8 font-serif">
  <div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8 leading-relaxed text-gray-800">
      ...
      <p class="mb-4">
        Thank you for your application to Dartmouth College. After careful consideration by 
      ...
      <p class="mb-4">
        ...
        application was evaluated holistically, considering academic achievement, personal qualities, 
        extracurricular involvement, and potential contributions to our close-knit community in 
        Hanover.
      </p>
      ...
      <div class="my-8 p-6 bg-gray-50 border-l-4 border-[#00693E] italic">
        ...
        <p class="text-gray-600">
          Dartmouth seeks students who demonstrate exceptional intellectual ability, curiosity, 
          and a commitment to community engagement. While you have clearly demonstrated 
          significant accomplishments, the limitations of our class size prevent us from admitting 
          many outstanding students who would undoubtedly thrive at Dartmouth.
        </p>
      </div>
