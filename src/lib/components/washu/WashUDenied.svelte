...
<div class="min-h-screen bg-white p-8 font-serif">
  <div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8 leading-relaxed text-gray-800">
      ...
      <p class="mb-4">
        Thank you for your application to Washington University in St. Louis. After careful consideration by 
        our Admissions Committee, I regret to inform you that we are unable to offer you admission 
        to the Class of 2028.
      </p>
      
      <p class="mb-4">
        This year, Washington University reviewed applications from an exceptionally accomplished pool of 
        more than 32,000 candidates. Each application was evaluated holistically, considering 
        academic achievement, personal qualities, extracurricular involvement, and potential 
        contributions to our collaborative campus community in St. Louis.
      </p>
      ...
      <div class="my-8 p-6 bg-gray-50 border-l-4 border-[#A51417] italic">
        ...
        <p class="text-gray-600">
          Washington University seeks students who demonstrate exceptional academic ability, intellectual 
          curiosity, and a commitment to community engagement. While you have clearly demonstrated 
          significant accomplishments, the limitations of our class size prevent us from admitting 
          many outstanding students who would undoubtedly thrive at WashU.
        </p>
      </div>
