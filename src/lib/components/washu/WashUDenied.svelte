	...
	<div class="max-w-2xl mx-auto">
		...
		<div class="border-b-2 border-gray-300 pb-4 mb-8">
			<div class="flex items-center mb-4">
				...
				<div>
					<h1 class="text-2xl font-bold text-gray-700">Washington University in St. Louis</h1>
		...
		<div class="mb-8 leading-relaxed text-gray-800">
			...
			<p class="mb-4">
				Thank you for your application to Washington University in St. Louis. After careful
			...
			<p class="mb-4">
				This year, Washington University reviewed applications from an exceptionally accomplished
				pool of more than 32,000 candidates. Each application was evaluated holistically,
				considering academic achievement, personal qualities, extracurricular involvement, and
				potential contributions to our collaborative campus community in St. Louis.
			</p>

			<div class="my-8 p-6 bg-gray-50 border-l-4 border-[#A51417] italic">
				<p class="mb-2 font-semibold text-gray-700">About Our Selection Process</p>
				<p class="text-gray-600">
					Washington University seeks students who demonstrate exceptional academic ability,
					intellectual curiosity, and a commitment to community engagement. While you have clearly
					demonstrated significant accomplishments, the limitations of our class size prevent us
					from admitting many outstanding students who would undoubtedly thrive at WashU.
				</p>
			</div>
