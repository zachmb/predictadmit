    ...
    {/if}
		...
		<div class="space-y-4 mb-8">
			<p>
				...
				admitted to the Johns Hopkins University Class of 2029. Your application impressed us with
				its depth, intellectual promise, and commitment to scholarship, and we believe that you will
				contribute significantly to the Hopkins community.
			</p>

			<p>
				This year, Johns Hopkins received a record number of applications for our entering class.
				Your admission is a tremendous accomplishment, and we hope you will join us next fall in
				Baltimore. The diverse perspectives, talents, and experiences you bring will enrich our
				campus in meaningful ways.
			</p>

			<p>
				You are invited to attend our admitted students program, **Hopkins Hosting**, from April
				16-18, 2025. This program will give you the opportunity to experience life at Hopkins
				firsthand, meet current students and faculty, and connect with your future classmates.
			</p>

			<p>
				To accept your offer of admission, please complete the reply form available in your
				admissions portal by <strong>May 1, 2025</strong>. You will also find important information
			...
			<p>
				...
				the Johns Hopkins family in August.
			</p>
		</div>
